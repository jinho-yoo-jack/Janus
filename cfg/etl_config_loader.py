...
class ETLConfigLoader:
    ...
    def load_configs(
        ...
        Args:
            ...
            oracle_db_name: Oracle 데이터베이스명 -> cfg/{oracle_db_name}
            table_name: 테이블명                -> cfg/{oracle_db_name}/tables/{table_name}.yml
            common_config_path: 공통 설정 파일 경로 (기본값: cfg/application.yml)
